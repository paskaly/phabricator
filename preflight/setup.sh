...
mv php-fpm.conf /etc/php/7.1/fpm/php-fpm.conf.template
mv php.ini /etc/php/7.1/fpm/php.ini
...
# Install PHPExcel
echo '' >> /etc/php/7.1/fpm/php-fpm.conf
echo 'php_value[include_path] = "/srv/phabricator/PHPExcel/Classes"' >> /etc/php/7.1/fpm/php-fpm.conf
